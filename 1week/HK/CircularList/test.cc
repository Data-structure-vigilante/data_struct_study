...
TEST(addCLElement, when_addOneNodeFirstPosition_expect_canCirculate) {
    ...
    EXPECT_EQ(list->headerNode.pLink, list->headerNode.pLink->pLink);
    EXPECT_EQ(list->headerNode.pLink->pLink,
              list->headerNode.pLink->pLink->pLink->pLink);
}
...
TEST(addCLElement, when_addNodeToMiddlePosition_expect_canCirculate) {
    ...
    EXPECT_EQ(list->headerNode.pLink,
              list->headerNode.pLink->pLink->pLink->pLink);
    EXPECT_EQ(list->headerNode.pLink->pLink,
              list->headerNode.pLink->pLink->pLink->pLink->pLink);
}
...
TEST(removeCLElement, when_ManyElementRemoveFirstPosition_expect_success) {
    CircularList *list = createCircularList();
    ListNode element;
    ...
    EXPECT_EQ(list->headerNode.pLink->data, 1);
}
